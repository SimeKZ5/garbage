...
console.log(maskCreditCard(132413512512341));
maskCreditCard('123412354125312341');
...
console.log(annoucement.replaceAll('door', 'gate')); // new JS update
...
if (plane.startsWith('Airubus') && plane.endsWith('neo')) {
